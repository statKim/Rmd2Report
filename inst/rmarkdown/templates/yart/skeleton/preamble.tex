...
% \usepackage{times}   % If it uses, bold face does not appear.
\usepackage{setspace}
...
\usepackage{subfig}
\usepackage{color}
% \usepackage{natbib}   % already included in template-yart.tex
\usepackage{lscape}
\usepackage{graphics}
\usepackage{fancyvrb,enumerate}
% \usepackage{mathtools}   % Add into template-yart.tex line 35
\usepackage{verbatim}
